--TEST--
Games_Chess_Crazyhouse->moveSAN() move king
--SKIPIF--
--FILE--
<?php
...
$phpunit->assertTrue($err, 'adding B king failed');
$err = $board->moveSAN('Ke2');
$phpunit->assertTrue($err, 'moving W king failed');
...
$phpunit->assertTrue($err, 'moving B king failed');

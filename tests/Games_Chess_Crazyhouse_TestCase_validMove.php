...
class Games_Chess_Crazyhouse_TestCase_validMove extends PHPUnit_TestCase
{
    /**
    ...
    function Games_Chess_Crazyhouse_TestCase_validMove($name)
    {
    ...
    function test_invalid_placement_1()
    {
        ...
        $this->board->blankBoard();
        $err = $this->board->_validMove($this->board->_parseMove('P@a5'));
        $this->assertEquals('pear_error', strtolower(get_class($err)), 'no error returned');
        $this->assertEquals('There are no captured Black Pawns available to place',
            $err->getMessage(), 'wrong error message');
        $err = $this->board->_validMove($this->board->_parseMove('B@a5'));
        $this->assertEquals('pear_error', strtolower(get_class($err)), 'no error returned');
        $this->assertEquals('There are no captured Black Bishops available to place',
            $err->getMessage(), 'wrong error message');
        $err = $this->board->_validMove($this->board->_parseMove('R@a5'));
        $this->assertEquals('pear_error', strtolower(get_class($err)), 'no error returned');
        $this->assertEquals('There are no captured Black Rooks available to place',
            $err->getMessage(), 'wrong error message');
        $err = $this->board->_validMove($this->board->_parseMove('Q@a5'));
        $this->assertEquals('pear_error', strtolower(get_class($err)), 'no error returned');
        $this->assertEquals('There are no captured Black Queens available to place',
            $err->getMessage(), 'wrong error message');
        $err = $this->board->_validMove($this->board->_parseMove('N@a5'));
        $this->assertEquals('pear_error', strtolower(get_class($err)), 'no error returned');
        $this->assertEquals('There are no captured Black Knights available to place',
            $err->getMessage(), 'wrong error message');
    }

    function test_invalid_placement_2()
    {
        if (!$this->_methodExists('_validMove')) {
            return;
        }
        ...
        $this->board->moveSAN('bxa3');
        $this->board->moveSAN('h6');
        $this->board->addPiece('W', 'B', 'a5');
        $err = $this->board->_validMove($this->board->_parseMove('P@a5'));
        $this->assertEquals('pear_error', strtolower(get_class($err)), 'no error returned');
        $this->assertEquals('There is already a piece on a5, cannot place another there',
            $err->getMessage(), 'wrong error message');
        $this->board->resetGame();
        $this->board->blankBoard();
        $this->board->addPiece('B', 'P', 'a3');
    ...
    function test_valid_placement()
    {
        ...
        $this->board->moveSAN('h6');
        $err = $this->board->_validMove($this->board->_parseMove('P@a5'));
        $this->assertTrue($err, 'first placement');
        $this->board->resetGame();
        $this->board->blankBoard();
        $this->board->addPiece('B', 'P', 'a3');
        $this->board->addPiece('B', 'P', 'h7');
        ...
        $this->board->moveSAN('h6');
        $err = $this->board->_validMove($this->board->_parseMove('P@a5'));
        $this->assertTrue($err, 'second placement');
    }

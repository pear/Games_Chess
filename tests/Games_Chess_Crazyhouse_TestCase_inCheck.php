...
class Games_Chess_Crazyhouse_TestCase_inCheck extends PHPUnit_TestCase
{
    /**
     * A Games_Chess_Crazyhouse object
     * @var        object
     */
    var $board;

    function Games_Chess_Crazyhouse_TestCase_inCheck($name)
    {
    ...
    function test_valid_doublecheck()
    {
        ...
        $this->assertEquals(array('b4', 'd3'), $piece, 'wrong attacking pieces');
    }
}

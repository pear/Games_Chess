...
class Games_Chess_Crazyhouse_TestCase_getAllPieceSquares extends PHPUnit_TestCase
{
    /**
    ...
    function Games_Chess_Crazyhouse_TestCase_getAllPieceSquares($name)
    {
    ...
    function test_valid_pieces_in_pawnb()
    {
        ...
        $this->assertEquals(array('h5', 'a5', 'g4'), $this->board->_getAllPieceSquares('N', 'B'));
    }
    ...
    function test_valid_excludeb()
    {
        ...
        $this->assertEquals(array('h5', 'g4'), $this->board->_getAllPieceSquares('N', 'B', 'a5'));
    }
}

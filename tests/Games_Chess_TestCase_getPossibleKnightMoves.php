...
class Games_Chess_TestCase_getPossibleKnightMoves extends PHPUnit_TestCase
{
    /**
    ...
    function Games_Chess_TestCase_getPossibleKnightMoves($name)
    {
    ...
    function test_validw1()
    {
        ...
        $err = $this->board->getPossibleKnightMoves('b1', 'W');
        $this->assertEquals(array('a3', 'c3'), $err, 'wrong squares');
    }
    ...
    function test_validw2()
    {
        ...
        $this->board->resetGame();
        $err = $this->board->getPossibleKnightMoves('e4', 'W');
        $this->assertEquals(array('c5', 'd6', 'f6', 'g5', 'g3', 'c3'), $err, 'wrong squares');
    }
    ...
    function test_validw3()
    {
        ...
        $this->board->resetGame();
        $err = $this->board->getPossibleKnightMoves('e5', 'W');
        $this->assertEquals(array('c6', 'd7', 'f7', 'g6', 'g4', 'f3', 'd3', 'c4'), $err, 'wrong squares');
    }
    ...
    function test_validb1()
    {
        ...
        $this->board->resetGame();
        $err = $this->board->getPossibleKnightMoves('b8', 'B');
        $this->assertEquals(array('c6', 'a6'), $err, 'wrong squares');
    }
    ...
    function test_validb2()
    {
        ...
        $this->board->resetGame();
        $err = $this->board->getPossibleKnightMoves('e5', 'B');
        $this->assertEquals(array('c6', 'g6', 'g4', 'f3', 'd3', 'c4'), $err, 'wrong squares');
    }
    ...
    function test_validb3()
    {
        ...
        $this->board->resetGame();
        $err = $this->board->getPossibleKnightMoves('e4', 'B');
        $this->assertEquals(array('c5', 'd6', 'f6', 'g5', 'g3', 'f2', 'd2', 'c3'), $err, 'wrong squares');
    }
}
